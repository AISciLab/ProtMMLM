...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--energy-csv", type=Path, default=Path("datasets/downstream/Thermodynamic/thermodynamic.csv"), help="Frame-level thermodynamic CSV with sample, frame, and energy-term columns.")
    parser.add_argument(
        "--energy-frame-offset",
        type=int,
        default=1,
