...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--energy-csv", type=Path, default=Path("data/downstream/all_interactions_all.csv"), help="Frame-level energy CSV with sample, frame, and total_score columns.")
    parser.add_argument(
        "--energy-frame-offset",
        type=int,
        default=1,
